/****************************************************************************
 * arch/risc-v/src/bl702/bl702_efuse.c
 *
...
#define bl702_romapi_efuse_ctrl_load_r0 \
  ((void (*)(void))BL702_ROMAPI_EFUSE_CTRL_LOAD_R0)
...
/****************************************************************************
 * Name: bl702_efuse_read_mac_address
 *
 * Description:
...
int bl702_efuse_read_mac_address(uint8_t mac[6])
{
  ...
  bl702_romapi_efuse_ctrl_load_r0();

  tmp_val   = getreg32(BL702_EF_WIFI_MAC_LOW);
  maclow[0] = tmp_val & 0xff;
  maclow[1] = (tmp_val >> 8) & 0xff;
  maclow[2] = (tmp_val >> 16) & 0xff;
  maclow[3] = (tmp_val >> 24) & 0xff;

  tmp_val    = getreg32(BL702_EF_WIFI_MAC_HIGH);
