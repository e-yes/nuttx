/****************************************************************************
 * arch/risc-v/src/bl702/bl702_start.c
 *
...
#define BL702_IDLESTACK_SIZE (CONFIG_IDLETHREAD_STACKSIZE)
...
uint8_t g_idle_stack[BL702_IDLESTACK_SIZE]
...
extern void bl702_lowsetup(void);
extern void exception_common(void);
extern void bl702_boardinitialize(void);
...
void bfl_main(void)
{
  ...
  g_idle_topstack = ((uint32_t)g_idle_stack + BL702_IDLESTACK_SIZE);
  ...
  modifyreg32(BL702_HBN_IRQ_MODE, 0, HBN_IRQ_MODE_REG_AON_PAD_IE_SMT);
