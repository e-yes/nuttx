/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_rf.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_RF_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_RF_H
...
#define BL702_RF_REV_OFFSET                  0x000000  /* Silicon revision */
#define BL702_RF_FSM_CTRL_HW_OFFSET          0x000004  /* Digital Control */
#define BL702_RF_FSM_CTRL_SW_OFFSET          0x000008  /* rfsm status reg */
#define BL702_RFCTRL_HW_EN_OFFSET            0x00000c  /* Control logic switch */
#define BL702_RF_TEMP_COMP_OFFSET            0x000010  /* temp_comp */
#define BL702_RFCAL_STATUS_OFFSET            0x000014  /* rfcal_status */
#define BL702_RFCAL_STATUS2_OFFSET           0x000018  /* rfcal_status2 */
#define BL702_RFCAL_CTRLEN_OFFSET            0x00001c  /* Calibration mode register */
#define BL702_RFCAL_STATEEN_OFFSET           0x000020  /* rf calibration state enable in full cal list */
#define BL702_RF_SARADC_RESV_OFFSET          0x000024  /* SARADC Control Registers */
#define BL702_RF_BASE_CTRL1_OFFSET           0x000028  /* ZRF Control register 0 */
#define BL702_RF_BASE_CTRL2_OFFSET           0x00002c  /* ZRF Control register 0 */
#define BL702_RF_PUCR1_OFFSET                0x000030  /* pucr1 */
#define BL702_RF_PUCR1_HW_OFFSET             0x000034  /* read only from hardware logic */
#define BL702_RF_PUCR2_OFFSET                0x000038  /* pucr2 */
#define BL702_RF_PUCR2_HW_OFFSET             0x00003c  /* pucr2_hw */
#define BL702_RF_PPU_CTRL_HW_OFFSET          0x000040  /* ppu_ctrl_hw */
#define BL702_RF_TRX_GAIN1_OFFSET            0x000048  /* gain control1 */
#define BL702_RF_PUD_CTRL_HW_OFFSET          0x000044  /* pud_ctrl_hw */
#define BL702_RF_TEN_DC_OFFSET               0x000050  /* dc test register */
#define BL702_RF_TRX_GAIN_HW_OFFSET          0x00004c  /* trx gain hardware readback */
#define BL702_RF_TEN_AC_OFFSET               0x000058  /* ac test register */
#define BL702_RF_TEN_DIG_OFFSET              0x000054  /* digital test register */
#define BL702_RF_CIP_OFFSET                  0x000060  /* RX normal bias mode registers */
#define BL702_RF_PMIP_MV2AON_OFFSET          0x00005c  /* pmip_mv2aon */
#define BL702_RF_PA2_OFFSET                  0x000068  /* RX normal bias mode registers */
#define BL702_RF_PA1_OFFSET                  0x000064  /* pa1 */
#define BL702_RF_TBB_OFFSET                  0x000070  /* tbb */
#define BL702_RF_TMX_OFFSET                  0x00006c  /* tmx */
#define BL702_RF_RMXGM_OFFSET                0x000078  /* rmxgm */
#define BL702_RF_LNA_OFFSET                  0x000074  /* lna */
#define BL702_RF_RBB2_OFFSET                 0x000080  /* rbb2 */
#define BL702_RF_RBB1_OFFSET                 0x00007c  /* rbb1 */
#define BL702_RF_RBB4_OFFSET                 0x000088  /* rbb4 */
#define BL702_RF_RBB3_OFFSET                 0x000084  /* rbb3 */
#define BL702_RF_ADDA2_OFFSET                0x000090  /* adda2 */
#define BL702_RF_ADDA1_OFFSET                0x00008c  /* adda1 */
#define BL702_RF_VCO2_OFFSET                 0x0000a4  /* vco2 */
#define BL702_RF_VCO1_OFFSET                 0x0000a0  /* vco1 */
#define BL702_RF_VCO4_OFFSET                 0x0000ac  /* vco4 */
#define BL702_RF_VCO3_OFFSET                 0x0000a8  /* vco3 */
#define BL702_RF_LO_OFFSET                   0x0000b4  /* lo */
#define BL702_RF_PFDCP_OFFSET                0x0000b0  /* pfdcp */
#define BL702_RF_LODIST_OFFSET               0x0000bc  /* lodist */
#define BL702_RF_FBDV_OFFSET                 0x0000b8  /* fbdv */
#define BL702_RF_SDM2_OFFSET                 0x0000c4  /* sdm2 */
#define BL702_RF_SDM1_OFFSET                 0x0000c0  /* sdm1 */
#define BL702_RF_RESV_REG_0_OFFSET           0x0000ec  /* rf_resv_reg_0 */
#define BL702_RF_SDM3_OFFSET                 0x0000c8  /* sdm3 */
#define BL702_RF_RESV_REG_2_OFFSET           0x0000f4  /* rf_resv_reg_2 */
#define BL702_RF_RESV_REG_1_OFFSET           0x0000f0  /* rf_resv_reg_1 */
#define BL702_RRF_GAIN_INDEX2_OFFSET         0x0000fc  /* rrf_gain_index2 */
#define BL702_RRF_GAIN_INDEX1_OFFSET         0x0000f8  /* rrf_gain_index1 */
#define BL702_RF_LNA_CTRL_HW_MUX_OFFSET      0x000100  /* lna_ctrl_hw_mux */
#define BL702_RF_RBB_GAIN_INDEX1_OFFSET      0x000104  /* rbb_gain_index1 */
#define BL702_RF_RBB_GAIN_INDEX2_OFFSET      0x000108  /* rbb_gain_index2 */
#define BL702_RF_RBB_GAIN_INDEX3_OFFSET      0x00010c  /* rbb_gain_index3 */
#define BL702_RF_RBB_GAIN_INDEX4_OFFSET      0x000110  /* rbb_gain_index4 */
#define BL702_RF_RBB_GAIN_INDEX5_OFFSET      0x000114  /* rbb_gain_index5 */
#define BL702_RF_TBB_GAIN_INDEX1_OFFSET      0x000118  /* tbb_gain_index1 */
#define BL702_RF_TBB_GAIN_INDEX2_OFFSET      0x00011c  /* tbb_gain_index2 */
#define BL702_RF_TBB_GAIN_INDEX3_OFFSET      0x000120  /* tbb_gain_index3 */
#define BL702_RF_TBB_GAIN_INDEX4_OFFSET      0x000124  /* tbb_gain_index4 */
#define BL702_RF_PA_REG_CTRL_HW1_OFFSET      0x000128  /* pa_reg_ctrl_hw1 */
#define BL702_RF_PA_REG_CTRL_HW2_OFFSET      0x00012c  /* pa_reg_ctrl_hw2 */
#define BL702_RF_PA_REG_WIFI_CTRL_HW_OFFSET  0x000130  /* pa_reg_wifi_ctrl_hw */
#define BL702_RF_ADDA_REG_CTRL_HW_OFFSET     0x000134  /* adda_reg_ctrl_hw */
#define BL702_RF_LO_REG_CTRL_HW1_OFFSET      0x000138  /* lo_reg_ctrl_hw1 */
#define BL702_RF_LO_CAL_CTRL_HW1_OFFSET      0x00013c  /* lo_cal_ctrl_hw1 */
#define BL702_RF_LO_CAL_CTRL_HW2_OFFSET      0x000140  /* lo_cal_ctrl_hw2 */
#define BL702_RF_LO_CAL_CTRL_HW3_OFFSET      0x000144  /* lo_cal_ctrl_hw3 */
#define BL702_RF_LO_CAL_CTRL_HW4_OFFSET      0x000148  /* lo_cal_ctrl_hw4 */
#define BL702_RF_LO_CAL_CTRL_HW5_OFFSET      0x00014c  /* lo_cal_ctrl_hw5 */
#define BL702_RF_LO_CAL_CTRL_HW6_OFFSET      0x000150  /* lo_cal_ctrl_hw6 */
#define BL702_RF_LO_CAL_CTRL_HW7_OFFSET      0x000154  /* lo_cal_ctrl_hw7 */
#define BL702_RF_LO_CAL_CTRL_HW8_OFFSET      0x000158  /* lo_cal_ctrl_hw8 */
#define BL702_RF_LO_CAL_CTRL_HW9_OFFSET      0x00015c  /* lo_cal_ctrl_hw9 */
#define BL702_RF_LO_CAL_CTRL_HW10_OFFSET     0x000160  /* lo_cal_ctrl_hw10 */
#define BL702_RF_LO_CAL_CTRL_HW11_OFFSET     0x000164  /* lo_cal_ctrl_hw11 */
#define BL702_RF_ROSDAC_CTRL_HW1_OFFSET      0x000168  /* rosdac_ctrl_hw1 */
#define BL702_RF_ROSDAC_CTRL_HW2_OFFSET      0x00016c  /* rosdac_ctrl_hw2 */
#define BL702_RF_RXIQ_CTRL_HW1_OFFSET        0x000170  /* rxiq_ctrl_hw1 */
#define BL702_RF_RXIQ_CTRL_HW2_OFFSET        0x000174  /* rxiq_ctrl_hw2 */
#define BL702_RF_RXIQ_CTRL_HW3_OFFSET        0x000178  /* rxiq_ctrl_hw3 */
#define BL702_RF_RXIQ_CTRL_HW4_OFFSET        0x00017c  /* rxiq_ctrl_hw4 */
#define BL702_RF_TOSDAC_CTRL_HW1_OFFSET      0x000180  /* tosdac_ctrl_hw1 */
#define BL702_RF_TOSDAC_CTRL_HW2_OFFSET      0x000184  /* tosdac_ctrl_hw2 */
#define BL702_RF_TOSDAC_CTRL_HW3_OFFSET      0x000188  /* tosdac_ctrl_hw3 */
#define BL702_RF_TOSDAC_CTRL_HW4_OFFSET      0x00018c  /* tosdac_ctrl_hw4 */
#define BL702_RF_TX_IQ_GAIN_HW0_OFFSET       0x000190  /* tx_iq_gain_hw0 */
#define BL702_RF_TX_IQ_GAIN_HW1_OFFSET       0x000194  /* tx_iq_gain_hw1 */
#define BL702_RF_TX_IQ_GAIN_HW2_OFFSET       0x000198  /* tx_iq_gain_hw2 */
#define BL702_RF_TX_IQ_GAIN_HW3_OFFSET       0x00019c  /* tx_iq_gain_hw3 */
#define BL702_RF_TX_IQ_GAIN_HW4_OFFSET       0x0001a0  /* tx_iq_gain_hw4 */
#define BL702_RF_TX_IQ_GAIN_HW5_OFFSET       0x0001a4  /* tx_iq_gain_hw5 */
#define BL702_RF_TX_IQ_GAIN_HW6_OFFSET       0x0001a8  /* tx_iq_gain_hw6 */
#define BL702_RF_TX_IQ_GAIN_HW7_OFFSET       0x0001ac  /* tx_iq_gain_hw7 */
#define BL702_RF_LO_SDM_CTRL_HW1_OFFSET      0x0001b0  /* lo_sdm_ctrl_hw1 */
#define BL702_RF_LO_SDM_CTRL_HW2_OFFSET      0x0001b4  /* lo_sdm_ctrl_hw2 */
#define BL702_RF_LO_SDM_CTRL_HW3_OFFSET      0x0001b8  /* lo_sdm_ctrl_hw3 */
#define BL702_RF_LO_SDM_CTRL_HW4_OFFSET      0x0001bc  /* lo_sdm_ctrl_hw4 */
#define BL702_RF_LO_SDM_CTRL_HW5_OFFSET      0x0001c0  /* lo_sdm_ctrl_hw5 */
#define BL702_RF_LO_SDM_CTRL_HW6_OFFSET      0x0001c4  /* lo_sdm_ctrl_hw6 */
#define BL702_RF_LO_SDM_CTRL_HW7_OFFSET      0x0001c8  /* lo_sdm_ctrl_hw7 */
#define BL702_RF_LO_SDM_CTRL_HW8_OFFSET      0x0001cc  /* lo_sdm_ctrl_hw8 */
#define BL702_RF_RBB_BW_CTRL_HW_OFFSET       0x0001d0  /* rbb_bw_ctrl_hw */
#define BL702_RF_SINGEN_CTRL0_OFFSET         0x00020c  /* singen_ctrl0 */
#define BL702_RF_SINGEN_CTRL1_OFFSET         0x000210  /* singen_ctrl1 */
#define BL702_RF_SINGEN_CTRL2_OFFSET         0x000214  /* singen_ctrl2 */
#define BL702_RF_SINGEN_CTRL3_OFFSET         0x000218  /* singen_ctrl3 */
#define BL702_RF_SINGEN_CTRL4_OFFSET         0x00021c  /* singen_ctrl4 */
#define BL702_RF_RFIF_DFE_CTRL0_OFFSET       0x000220  /* rfif_dfe_ctrl0 */
#define BL702_RF_RFIF_TEST_READ_OFFSET       0x000224  /* rfif_test_read */
#define BL702_RF_RFIF_DIG_CTRL_OFFSET        0x000228  /* rfif_dig_ctrl */
#define BL702_RF_DATA_TEMP_0_OFFSET          0x00022c  /* rf_data_temp_0 */
#define BL702_RF_DATA_TEMP_1_OFFSET          0x000230  /* rf_data_temp_1 */
#define BL702_RF_DATA_TEMP_2_OFFSET          0x000234  /* rf_data_temp_2 */
#define BL702_RF_DATA_TEMP_3_OFFSET          0x000238  /* rf_data_temp_3 */
#define BL702_RF_SRAM_CTRL0_OFFSET           0x00023c  /* rf_sram_ctrl0 */
#define BL702_RF_SRAM_CTRL1_OFFSET           0x000240  /* rf_sram_ctrl1 */
#define BL702_RF_SRAM_CTRL2_OFFSET           0x000244  /* rf_sram_ctrl2 */
#define BL702_RF_SRAM_CTRL3_OFFSET           0x000248  /* rf_sram_ctrl3 */
#define BL702_RF_SRAM_CTRL4_OFFSET           0x00024c  /* rf_sram_ctrl4 */
#define BL702_RF_SRAM_CTRL5_OFFSET           0x000250  /* rf_sram_ctrl5 */
#define BL702_RF_SRAM_CTRL6_OFFSET           0x000254  /* rf_sram_ctrl6 */
#define BL702_RF_ICAL_CTRL0_OFFSET           0x000258  /* rf_ical_ctrl0 */
#define BL702_RF_ICAL_CTRL1_OFFSET           0x00025c  /* rf_ical_ctrl1 */
#define BL702_RF_ICAL_CTRL2_OFFSET           0x000260  /* rf_ical_ctrl2 */
#define BL702_RF_FSM_CTRL0_OFFSET            0x000264  /* rf_fsm_ctrl0 */
#define BL702_RF_FSM_CTRL1_OFFSET            0x000268  /* rf_fsm_ctrl1 */
#define BL702_RF_FSM_CTRL2_OFFSET            0x00026c  /* rf_fsm_ctrl2 */
#define BL702_RF_PKDET_CTRL0_OFFSET          0x000270  /* rf_pkdet_ctrl0 */
#define BL702_RF_DFE_CTRL_0_OFFSET           0x000600  /* dfe_ctrl_0 */
#define BL702_RF_DFE_CTRL_1_OFFSET           0x000604  /* dfe_ctrl_1 */
#define BL702_RF_DFE_CTRL_2_OFFSET           0x000608  /* dfe_ctrl_2 */
#define BL702_RF_DFE_CTRL_3_OFFSET           0x00060c  /* dfe_ctrl_3 */
#define BL702_RF_DFE_CTRL_4_OFFSET           0x000610  /* dfe_ctrl_4 */
#define BL702_RF_DFE_CTRL_5_OFFSET           0x000614  /* dfe_ctrl_5 */
#define BL702_RF_DFE_CTRL_6_OFFSET           0x000618  /* dfe_ctrl_6 */
#define BL702_RF_DFE_CTRL_7_OFFSET           0x00061c  /* dfe_ctrl_7 */
#define BL702_RF_DFE_CTRL_8_OFFSET           0x000620  /* dfe_ctrl_8 */
#define BL702_RF_DFE_CTRL_9_OFFSET           0x000624  /* dfe_ctrl_9 */
#define BL702_RF_DFE_CTRL_10_OFFSET          0x000628  /* dfe_ctrl_10 */
#define BL702_RF_DFE_CTRL_11_OFFSET          0x00062c  /* dfe_ctrl_11 */
#define BL702_RF_DFE_CTRL_12_OFFSET          0x000630  /* dfe_ctrl_12 */
#define BL702_RF_DFE_CTRL_13_OFFSET          0x000634  /* dfe_ctrl_13 */
#define BL702_RF_DFE_CTRL_14_OFFSET          0x000638  /* dfe_ctrl_14 */
#define BL702_RF_DFE_CTRL_15_OFFSET          0x00063c  /* dfe_ctrl_15 */
#define BL702_RF_DFE_CTRL_16_OFFSET          0x000640  /* dfe_ctrl_16 */
#define BL702_RF_DFE_CTRL_17_OFFSET          0x000644  /* dfe_ctrl_17 */
#define BL702_RF_DFE_CTRL_18_OFFSET          0x000648  /* dfe_ctrl_18 */

/* Register definitions *****************************************************/

#define BL702_RF_REV                  (BL702_RF_BASE + BL702_RF_REV_OFFSET)
#define BL702_RF_FSM_CTRL_HW          (BL702_RF_BASE + BL702_RF_FSM_CTRL_HW_OFFSET)
#define BL702_RF_FSM_CTRL_SW          (BL702_RF_BASE + BL702_RF_FSM_CTRL_SW_OFFSET)
#define BL702_RFCTRL_HW_EN            (BL702_RF_BASE + BL702_RFCTRL_HW_EN_OFFSET)
#define BL702_RF_TEMP_COMP            (BL702_RF_BASE + BL702_RF_TEMP_COMP_OFFSET)
#define BL702_RFCAL_STATUS            (BL702_RF_BASE + BL702_RFCAL_STATUS_OFFSET)
#define BL702_RFCAL_STATUS2           (BL702_RF_BASE + BL702_RFCAL_STATUS2_OFFSET)
#define BL702_RFCAL_CTRLEN            (BL702_RF_BASE + BL702_RFCAL_CTRLEN_OFFSET)
#define BL702_RFCAL_STATEEN           (BL702_RF_BASE + BL702_RFCAL_STATEEN_OFFSET)
#define BL702_RF_SARADC_RESV          (BL702_RF_BASE + BL702_RF_SARADC_RESV_OFFSET)
#define BL702_RF_BASE_CTRL1           (BL702_RF_BASE + BL702_RF_BASE_CTRL1_OFFSET)
#define BL702_RF_BASE_CTRL2           (BL702_RF_BASE + BL702_RF_BASE_CTRL2_OFFSET)
#define BL702_RF_PUCR1                (BL702_RF_BASE + BL702_RF_PUCR1_OFFSET)
#define BL702_RF_PUCR1_HW             (BL702_RF_BASE + BL702_RF_PUCR1_HW_OFFSET)
#define BL702_RF_PUCR2                (BL702_RF_BASE + BL702_RF_PUCR2_OFFSET)
#define BL702_RF_PUCR2_HW             (BL702_RF_BASE + BL702_RF_PUCR2_HW_OFFSET)
#define BL702_RF_PPU_CTRL_HW          (BL702_RF_BASE + BL702_RF_PPU_CTRL_HW_OFFSET)
#define BL702_RF_PUD_CTRL_HW          (BL702_RF_BASE + BL702_RF_PUD_CTRL_HW_OFFSET)
#define BL702_RF_TRX_GAIN1            (BL702_RF_BASE + BL702_RF_TRX_GAIN1_OFFSET)
#define BL702_RF_TRX_GAIN_HW          (BL702_RF_BASE + BL702_RF_TRX_GAIN_HW_OFFSET)
#define BL702_RF_TEN_DC               (BL702_RF_BASE + BL702_RF_TEN_DC_OFFSET)
#define BL702_RF_TEN_DIG              (BL702_RF_BASE + BL702_RF_TEN_DIG_OFFSET)
#define BL702_RF_TEN_AC               (BL702_RF_BASE + BL702_RF_TEN_AC_OFFSET)
#define BL702_RF_PMIP_MV2AON          (BL702_RF_BASE + BL702_RF_PMIP_MV2AON_OFFSET)
#define BL702_RF_CIP                  (BL702_RF_BASE + BL702_RF_CIP_OFFSET)
#define BL702_RF_PA1                  (BL702_RF_BASE + BL702_RF_PA1_OFFSET)
#define BL702_RF_PA2                  (BL702_RF_BASE + BL702_RF_PA2_OFFSET)
#define BL702_RF_TMX                  (BL702_RF_BASE + BL702_RF_TMX_OFFSET)
#define BL702_RF_TBB                  (BL702_RF_BASE + BL702_RF_TBB_OFFSET)
#define BL702_RF_LNA                  (BL702_RF_BASE + BL702_RF_LNA_OFFSET)
#define BL702_RF_RMXGM                (BL702_RF_BASE + BL702_RF_RMXGM_OFFSET)
#define BL702_RF_RBB1                 (BL702_RF_BASE + BL702_RF_RBB1_OFFSET)
#define BL702_RF_RBB2                 (BL702_RF_BASE + BL702_RF_RBB2_OFFSET)
#define BL702_RF_RBB3                 (BL702_RF_BASE + BL702_RF_RBB3_OFFSET)
#define BL702_RF_RBB4                 (BL702_RF_BASE + BL702_RF_RBB4_OFFSET)
#define BL702_RF_ADDA1                (BL702_RF_BASE + BL702_RF_ADDA1_OFFSET)
#define BL702_RF_ADDA2                (BL702_RF_BASE + BL702_RF_ADDA2_OFFSET)
#define BL702_RF_VCO1                 (BL702_RF_BASE + BL702_RF_VCO1_OFFSET)
#define BL702_RF_VCO2                 (BL702_RF_BASE + BL702_RF_VCO2_OFFSET)
#define BL702_RF_VCO3                 (BL702_RF_BASE + BL702_RF_VCO3_OFFSET)
#define BL702_RF_VCO4                 (BL702_RF_BASE + BL702_RF_VCO4_OFFSET)
#define BL702_RF_PFDCP                (BL702_RF_BASE + BL702_RF_PFDCP_OFFSET)
#define BL702_RF_LO                   (BL702_RF_BASE + BL702_RF_LO_OFFSET)
#define BL702_RF_FBDV                 (BL702_RF_BASE + BL702_RF_FBDV_OFFSET)
#define BL702_RF_LODIST               (BL702_RF_BASE + BL702_RF_LODIST_OFFSET)
#define BL702_RF_SDM1                 (BL702_RF_BASE + BL702_RF_SDM1_OFFSET)
#define BL702_RF_SDM2                 (BL702_RF_BASE + BL702_RF_SDM2_OFFSET)
#define BL702_RF_SDM3                 (BL702_RF_BASE + BL702_RF_SDM3_OFFSET)
#define BL702_RF_RESV_REG_0           (BL702_RF_BASE + BL702_RF_RESV_REG_0_OFFSET)
#define BL702_RF_RESV_REG_1           (BL702_RF_BASE + BL702_RF_RESV_REG_1_OFFSET)
#define BL702_RF_RESV_REG_2           (BL702_RF_BASE + BL702_RF_RESV_REG_2_OFFSET)
#define BL702_RRF_GAIN_INDEX1         (BL702_RF_BASE + BL702_RRF_GAIN_INDEX1_OFFSET)
#define BL702_RRF_GAIN_INDEX2         (BL702_RF_BASE + BL702_RRF_GAIN_INDEX2_OFFSET)
#define BL702_RF_LNA_CTRL_HW_MUX      (BL702_RF_BASE + BL702_RF_LNA_CTRL_HW_MUX_OFFSET)
#define BL702_RF_RBB_GAIN_INDEX1      (BL702_RF_BASE + BL702_RF_RBB_GAIN_INDEX1_OFFSET)
#define BL702_RF_RBB_GAIN_INDEX2      (BL702_RF_BASE + BL702_RF_RBB_GAIN_INDEX2_OFFSET)
#define BL702_RF_RBB_GAIN_INDEX3      (BL702_RF_BASE + BL702_RF_RBB_GAIN_INDEX3_OFFSET)
#define BL702_RF_RBB_GAIN_INDEX4      (BL702_RF_BASE + BL702_RF_RBB_GAIN_INDEX4_OFFSET)
#define BL702_RF_RBB_GAIN_INDEX5      (BL702_RF_BASE + BL702_RF_RBB_GAIN_INDEX5_OFFSET)
#define BL702_RF_TBB_GAIN_INDEX1      (BL702_RF_BASE + BL702_RF_TBB_GAIN_INDEX1_OFFSET)
#define BL702_RF_TBB_GAIN_INDEX2      (BL702_RF_BASE + BL702_RF_TBB_GAIN_INDEX2_OFFSET)
#define BL702_RF_TBB_GAIN_INDEX3      (BL702_RF_BASE + BL702_RF_TBB_GAIN_INDEX3_OFFSET)
#define BL702_RF_TBB_GAIN_INDEX4      (BL702_RF_BASE + BL702_RF_TBB_GAIN_INDEX4_OFFSET)
#define BL702_RF_PA_REG_CTRL_HW1      (BL702_RF_BASE + BL702_RF_PA_REG_CTRL_HW1_OFFSET)
#define BL702_RF_PA_REG_CTRL_HW2      (BL702_RF_BASE + BL702_RF_PA_REG_CTRL_HW2_OFFSET)
#define BL702_RF_PA_REG_WIFI_CTRL_HW  (BL702_RF_BASE + BL702_RF_PA_REG_WIFI_CTRL_HW_OFFSET)
#define BL702_RF_ADDA_REG_CTRL_HW     (BL702_RF_BASE + BL702_RF_ADDA_REG_CTRL_HW_OFFSET)
#define BL702_RF_LO_REG_CTRL_HW1      (BL702_RF_BASE + BL702_RF_LO_REG_CTRL_HW1_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW1      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW1_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW2      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW2_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW3      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW3_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW4      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW4_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW5      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW5_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW6      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW6_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW7      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW7_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW8      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW8_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW9      (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW9_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW10     (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW10_OFFSET)
#define BL702_RF_LO_CAL_CTRL_HW11     (BL702_RF_BASE + BL702_RF_LO_CAL_CTRL_HW11_OFFSET)
#define BL702_RF_ROSDAC_CTRL_HW1      (BL702_RF_BASE + BL702_RF_ROSDAC_CTRL_HW1_OFFSET)
#define BL702_RF_ROSDAC_CTRL_HW2      (BL702_RF_BASE + BL702_RF_ROSDAC_CTRL_HW2_OFFSET)
#define BL702_RF_RXIQ_CTRL_HW1        (BL702_RF_BASE + BL702_RF_RXIQ_CTRL_HW1_OFFSET)
#define BL702_RF_RXIQ_CTRL_HW2        (BL702_RF_BASE + BL702_RF_RXIQ_CTRL_HW2_OFFSET)
#define BL702_RF_RXIQ_CTRL_HW3        (BL702_RF_BASE + BL702_RF_RXIQ_CTRL_HW3_OFFSET)
#define BL702_RF_RXIQ_CTRL_HW4        (BL702_RF_BASE + BL702_RF_RXIQ_CTRL_HW4_OFFSET)
#define BL702_RF_TOSDAC_CTRL_HW1      (BL702_RF_BASE + BL702_RF_TOSDAC_CTRL_HW1_OFFSET)
#define BL702_RF_TOSDAC_CTRL_HW2      (BL702_RF_BASE + BL702_RF_TOSDAC_CTRL_HW2_OFFSET)
#define BL702_RF_TOSDAC_CTRL_HW3      (BL702_RF_BASE + BL702_RF_TOSDAC_CTRL_HW3_OFFSET)
#define BL702_RF_TOSDAC_CTRL_HW4      (BL702_RF_BASE + BL702_RF_TOSDAC_CTRL_HW4_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW0       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW0_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW1       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW1_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW2       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW2_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW3       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW3_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW4       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW4_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW5       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW5_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW6       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW6_OFFSET)
#define BL702_RF_TX_IQ_GAIN_HW7       (BL702_RF_BASE + BL702_RF_TX_IQ_GAIN_HW7_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW1      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW1_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW2      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW2_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW3      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW3_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW4      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW4_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW5      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW5_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW6      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW6_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW7      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW7_OFFSET)
#define BL702_RF_LO_SDM_CTRL_HW8      (BL702_RF_BASE + BL702_RF_LO_SDM_CTRL_HW8_OFFSET)
#define BL702_RF_RBB_BW_CTRL_HW       (BL702_RF_BASE + BL702_RF_RBB_BW_CTRL_HW_OFFSET)
#define BL702_RF_SINGEN_CTRL0         (BL702_RF_BASE + BL702_RF_SINGEN_CTRL0_OFFSET)
#define BL702_RF_SINGEN_CTRL1         (BL702_RF_BASE + BL702_RF_SINGEN_CTRL1_OFFSET)
#define BL702_RF_SINGEN_CTRL2         (BL702_RF_BASE + BL702_RF_SINGEN_CTRL2_OFFSET)
#define BL702_RF_SINGEN_CTRL3         (BL702_RF_BASE + BL702_RF_SINGEN_CTRL3_OFFSET)
#define BL702_RF_SINGEN_CTRL4         (BL702_RF_BASE + BL702_RF_SINGEN_CTRL4_OFFSET)
#define BL702_RF_RFIF_DFE_CTRL0       (BL702_RF_BASE + BL702_RF_RFIF_DFE_CTRL0_OFFSET)
#define BL702_RF_RFIF_TEST_READ       (BL702_RF_BASE + BL702_RF_RFIF_TEST_READ_OFFSET)
#define BL702_RF_RFIF_DIG_CTRL        (BL702_RF_BASE + BL702_RF_RFIF_DIG_CTRL_OFFSET)
#define BL702_RF_DATA_TEMP_0          (BL702_RF_BASE + BL702_RF_DATA_TEMP_0_OFFSET)
#define BL702_RF_DATA_TEMP_1          (BL702_RF_BASE + BL702_RF_DATA_TEMP_1_OFFSET)
#define BL702_RF_DATA_TEMP_2          (BL702_RF_BASE + BL702_RF_DATA_TEMP_2_OFFSET)
#define BL702_RF_DATA_TEMP_3          (BL702_RF_BASE + BL702_RF_DATA_TEMP_3_OFFSET)
#define BL702_RF_SRAM_CTRL0           (BL702_RF_BASE + BL702_RF_SRAM_CTRL0_OFFSET)
#define BL702_RF_SRAM_CTRL1           (BL702_RF_BASE + BL702_RF_SRAM_CTRL1_OFFSET)
#define BL702_RF_SRAM_CTRL2           (BL702_RF_BASE + BL702_RF_SRAM_CTRL2_OFFSET)
#define BL702_RF_SRAM_CTRL3           (BL702_RF_BASE + BL702_RF_SRAM_CTRL3_OFFSET)
#define BL702_RF_SRAM_CTRL4           (BL702_RF_BASE + BL702_RF_SRAM_CTRL4_OFFSET)
#define BL702_RF_SRAM_CTRL5           (BL702_RF_BASE + BL702_RF_SRAM_CTRL5_OFFSET)
#define BL702_RF_SRAM_CTRL6           (BL702_RF_BASE + BL702_RF_SRAM_CTRL6_OFFSET)
#define BL702_RF_ICAL_CTRL0           (BL702_RF_BASE + BL702_RF_ICAL_CTRL0_OFFSET)
#define BL702_RF_ICAL_CTRL1           (BL702_RF_BASE + BL702_RF_ICAL_CTRL1_OFFSET)
#define BL702_RF_ICAL_CTRL2           (BL702_RF_BASE + BL702_RF_ICAL_CTRL2_OFFSET)
#define BL702_RF_FSM_CTRL0            (BL702_RF_BASE + BL702_RF_FSM_CTRL0_OFFSET)
#define BL702_RF_FSM_CTRL1            (BL702_RF_BASE + BL702_RF_FSM_CTRL1_OFFSET)
#define BL702_RF_FSM_CTRL2            (BL702_RF_BASE + BL702_RF_FSM_CTRL2_OFFSET)
#define BL702_RF_PKDET_CTRL0          (BL702_RF_BASE + BL702_RF_PKDET_CTRL0_OFFSET)
#define BL702_RF_DFE_CTRL_0           (BL702_RF_BASE + BL702_RF_DFE_CTRL_0_OFFSET)
#define BL702_RF_DFE_CTRL_1           (BL702_RF_BASE + BL702_RF_DFE_CTRL_1_OFFSET)
#define BL702_RF_DFE_CTRL_2           (BL702_RF_BASE + BL702_RF_DFE_CTRL_2_OFFSET)
#define BL702_RF_DFE_CTRL_3           (BL702_RF_BASE + BL702_RF_DFE_CTRL_3_OFFSET)
#define BL702_RF_DFE_CTRL_4           (BL702_RF_BASE + BL702_RF_DFE_CTRL_4_OFFSET)
#define BL702_RF_DFE_CTRL_5           (BL702_RF_BASE + BL702_RF_DFE_CTRL_5_OFFSET)
#define BL702_RF_DFE_CTRL_6           (BL702_RF_BASE + BL702_RF_DFE_CTRL_6_OFFSET)
#define BL702_RF_DFE_CTRL_7           (BL702_RF_BASE + BL702_RF_DFE_CTRL_7_OFFSET)
#define BL702_RF_DFE_CTRL_8           (BL702_RF_BASE + BL702_RF_DFE_CTRL_8_OFFSET)
#define BL702_RF_DFE_CTRL_9           (BL702_RF_BASE + BL702_RF_DFE_CTRL_9_OFFSET)
#define BL702_RF_DFE_CTRL_10          (BL702_RF_BASE + BL702_RF_DFE_CTRL_10_OFFSET)
#define BL702_RF_DFE_CTRL_11          (BL702_RF_BASE + BL702_RF_DFE_CTRL_11_OFFSET)
#define BL702_RF_DFE_CTRL_12          (BL702_RF_BASE + BL702_RF_DFE_CTRL_12_OFFSET)
#define BL702_RF_DFE_CTRL_13          (BL702_RF_BASE + BL702_RF_DFE_CTRL_13_OFFSET)
#define BL702_RF_DFE_CTRL_14          (BL702_RF_BASE + BL702_RF_DFE_CTRL_14_OFFSET)
#define BL702_RF_DFE_CTRL_15          (BL702_RF_BASE + BL702_RF_DFE_CTRL_15_OFFSET)
#define BL702_RF_DFE_CTRL_16          (BL702_RF_BASE + BL702_RF_DFE_CTRL_16_OFFSET)
#define BL702_RF_DFE_CTRL_17          (BL702_RF_BASE + BL702_RF_DFE_CTRL_17_OFFSET)
#define BL702_RF_DFE_CTRL_18          (BL702_RF_BASE + BL702_RF_DFE_CTRL_18_OFFSET)
