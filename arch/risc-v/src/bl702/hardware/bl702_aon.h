/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_aon.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_AON_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_AON_H
...
#define BL702_AON_OFFSET                   0x000800  /* aon */
#define BL702_AON_COMMON_OFFSET            0x000804  /* aon_common */
#define BL702_AON_MISC_OFFSET              0x000808  /* aon_misc */
#define BL702_BG_SYS_TOP_OFFSET            0x000810  /* bg_sys_top */
#define BL702_DCDC18_TOP_0_OFFSET          0x000814  /* dcdc18_top_0 */
#define BL702_DCDC18_TOP_1_OFFSET          0x000818  /* dcdc18_top_1 */
#define BL702_LDO11SOC_AND_DCTEST_OFFSET   0x00081c  /* ldo11soc_and_dctest */
#define BL702_PSW_IRRCV_OFFSET             0x000820  /* psw_irrcv */
#define BL702_RF_TOP_AON_OFFSET            0x000880  /* rf_top_aon */
#define BL702_XTAL_CFG_OFFSET              0x000884  /* xtal_cfg */
#define BL702_TSEN_OFFSET                  0x000888  /* tsen */
#define BL702_ACOMP0_CTRL_OFFSET           0x000900  /* acomp0_ctrl */
#define BL702_ACOMP1_CTRL_OFFSET           0x000904  /* acomp1_ctrl */
#define BL702_ACOMP_CTRL_OFFSET            0x000908  /* acomp_ctrl */
#define BL702_GPADC_REG_CMD_OFFSET         0x00090c  /* gpadc_reg_cmd */
#define BL702_GPADC_REG_CONFIG1_OFFSET     0x000910  /* gpadc_reg_config1 */
#define BL702_GPADC_REG_CONFIG2_OFFSET     0x000914  /* gpadc_reg_config2 */
#define BL702_GPADC_REG_SCN_POS1_OFFSET    0x000918  /* adc conversion sequence 1 */
#define BL702_GPADC_REG_SCN_POS2_OFFSET    0x00091c  /* adc conversion sequence 2 */
#define BL702_GPADC_REG_SCN_NEG1_OFFSET    0x000920  /* adc conversion sequence 3 */
#define BL702_GPADC_REG_SCN_NEG2_OFFSET    0x000924  /* adc conversion sequence 4 */
#define BL702_GPADC_REG_STATUS_OFFSET      0x000928  /* gpadc_reg_status */
#define BL702_GPADC_REG_ISR_OFFSET         0x00092c  /* gpadc_reg_isr */
#define BL702_GPADC_REG_RESULT_OFFSET      0x000930  /* gpadc_reg_result */
#define BL702_GPADC_REG_RAW_RESULT_OFFSET  0x000934  /* gpadc_reg_raw_result */
#define BL702_GPADC_REG_DEFINE_OFFSET      0x000938  /* gpadc_reg_define */
#define BL702_HBNCORE_RESV0_OFFSET         0x00093c  /* hbncore_resv0 */
#define BL702_HBNCORE_RESV1_OFFSET         0x000940  /* hbncore_resv1 */

/* Register definitions *****************************************************/

#define BL702_AON                   (BL702_AON_BASE + BL702_AON_OFFSET)
#define BL702_AON_COMMON            (BL702_AON_BASE + BL702_AON_COMMON_OFFSET)
#define BL702_AON_MISC              (BL702_AON_BASE + BL702_AON_MISC_OFFSET)
#define BL702_BG_SYS_TOP            (BL702_AON_BASE + BL702_BG_SYS_TOP_OFFSET)
#define BL702_DCDC18_TOP_0          (BL702_AON_BASE + BL702_DCDC18_TOP_0_OFFSET)
#define BL702_DCDC18_TOP_1          (BL702_AON_BASE + BL702_DCDC18_TOP_1_OFFSET)
#define BL702_LDO11SOC_AND_DCTEST   (BL702_AON_BASE + BL702_LDO11SOC_AND_DCTEST_OFFSET)
#define BL702_PSW_IRRCV             (BL702_AON_BASE + BL702_PSW_IRRCV_OFFSET)
#define BL702_RF_TOP_AON            (BL702_AON_BASE + BL702_RF_TOP_AON_OFFSET)
#define BL702_XTAL_CFG              (BL702_AON_BASE + BL702_XTAL_CFG_OFFSET)
#define BL702_TSEN                  (BL702_AON_BASE + BL702_TSEN_OFFSET)
#define BL702_ACOMP0_CTRL           (BL702_AON_BASE + BL702_ACOMP0_CTRL_OFFSET)
#define BL702_ACOMP1_CTRL           (BL702_AON_BASE + BL702_ACOMP1_CTRL_OFFSET)
#define BL702_ACOMP_CTRL            (BL702_AON_BASE + BL702_ACOMP_CTRL_OFFSET)
#define BL702_GPADC_REG_CMD         (BL702_AON_BASE + BL702_GPADC_REG_CMD_OFFSET)
#define BL702_GPADC_REG_CONFIG1     (BL702_AON_BASE + BL702_GPADC_REG_CONFIG1_OFFSET)
#define BL702_GPADC_REG_CONFIG2     (BL702_AON_BASE + BL702_GPADC_REG_CONFIG2_OFFSET)
#define BL702_GPADC_REG_SCN_POS1    (BL702_AON_BASE + BL702_GPADC_REG_SCN_POS1_OFFSET)
#define BL702_GPADC_REG_SCN_POS2    (BL702_AON_BASE + BL702_GPADC_REG_SCN_POS2_OFFSET)
#define BL702_GPADC_REG_SCN_NEG1    (BL702_AON_BASE + BL702_GPADC_REG_SCN_NEG1_OFFSET)
#define BL702_GPADC_REG_SCN_NEG2    (BL702_AON_BASE + BL702_GPADC_REG_SCN_NEG2_OFFSET)
#define BL702_GPADC_REG_STATUS      (BL702_AON_BASE + BL702_GPADC_REG_STATUS_OFFSET)
#define BL702_GPADC_REG_ISR         (BL702_AON_BASE + BL702_GPADC_REG_ISR_OFFSET)
#define BL702_GPADC_REG_RESULT      (BL702_AON_BASE + BL702_GPADC_REG_RESULT_OFFSET)
#define BL702_GPADC_REG_RAW_RESULT  (BL702_AON_BASE + BL702_GPADC_REG_RAW_RESULT_OFFSET)
#define BL702_GPADC_REG_DEFINE      (BL702_AON_BASE + BL702_GPADC_REG_DEFINE_OFFSET)
#define BL702_HBNCORE_RESV0         (BL702_AON_BASE + BL702_HBNCORE_RESV0_OFFSET)
#define BL702_HBNCORE_RESV1         (BL702_AON_BASE + BL702_HBNCORE_RESV1_OFFSET)
...
#endif /* __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_AON_H */
