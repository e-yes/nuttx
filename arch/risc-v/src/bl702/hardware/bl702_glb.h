/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_glb.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_GLB_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_GLB_H
...
#define BL702_CLK_CFG0_OFFSET               0x000000  /* clk_cfg0 */
#define BL702_CLK_CFG1_OFFSET               0x000004  /* clk_cfg1 */
#define BL702_CLK_CFG2_OFFSET               0x000008  /* clk_cfg2 */
#define BL702_CLK_CFG3_OFFSET               0x00000c  /* clk_cfg3 */
#define BL702_SWRST_CFG0_OFFSET             0x000010  /* swrst_cfg0 */
#define BL702_SWRST_CFG1_OFFSET             0x000014  /* swrst_cfg1 */
#define BL702_SWRST_CFG2_OFFSET             0x000018  /* swrst_cfg2 */
#define BL702_SWRST_CFG3_OFFSET             0x00001c  /* swrst_cfg3 */
#define BL702_CGEN_CFG0_OFFSET              0x000020  /* cgen_cfg0 */
#define BL702_CGEN_CFG1_OFFSET              0x000024  /* cgen_cfg1 */
#define BL702_CGEN_CFG2_OFFSET              0x000028  /* cgen_cfg2 */
#define BL702_CGEN_CFG3_OFFSET              0x00002c  /* cgen_cfg3 */
#define BL702_MBIST_CTL_OFFSET              0x000030  /* mbist_ctl */
#define BL702_MBIST_STAT_OFFSET             0x000034  /* mbist_stat */
#define BL702_BMX_CFG1_OFFSET               0x000050  /* bmx_cfg1 */
#define BL702_BMX_CFG2_OFFSET               0x000054  /* bmx_cfg2 */
#define BL702_BMX_ERR_ADDR_OFFSET           0x000058  /* bmx_err_addr */
#define BL702_BMX_DBG_OUT_OFFSET            0x00005c  /* bmx_dbg_out */
#define BL702_GLB_RSV0_OFFSET               0x000060  /* rsv0 */
#define BL702_GLB_RSV1_OFFSET               0x000064  /* rsv1 */
#define BL702_GLB_RSV2_OFFSET               0x000068  /* rsv2 */
#define BL702_GLB_RSV3_OFFSET               0x00006c  /* rsv3 */
#define BL702_SRAM_RET_OFFSET               0x000070  /* sram_ret */
#define BL702_SRAM_SLP_OFFSET               0x000074  /* sram_slp */
#define BL702_SRAM_PARM_OFFSET              0x000078  /* sram_parm */
#define BL702_SEAM_MISC_OFFSET              0x00007c  /* seam_misc */
#define BL702_GLB_PARM_OFFSET               0x000080  /* glb_parm */
#define BL702_CPU_CLK_CFG_OFFSET            0x000090  /* cpu_clk_cfg */
#define BL702_GPADC_32M_SRC_CTRL_OFFSET     0x0000a4  /* gpadc_32m_src_ctrl */
#define BL702_DIG32K_WAKEUP_CTRL_OFFSET     0x0000a8  /* dig32k_wakeup_ctrl */
#define BL702_WIFI_BT_COEX_CTRL_OFFSET      0x0000ac  /* wifi_bt_coex_ctrl */
#define BL702_UART_SIG_SEL_0_OFFSET         0x0000c0  /* uart_sig_sel_0 */
#define BL702_GLB_DBG_SEL_LL_OFFSET         0x0000d0  /* dbg_sel_ll */
#define BL702_GLB_DBG_SEL_LH_OFFSET         0x0000d4  /* dbg_sel_lh */
#define BL702_GLB_DBG_SEL_HL_OFFSET         0x0000d8  /* dbg_sel_hl */
#define BL702_GLB_DBG_SEL_HH_OFFSET         0x0000dc  /* dbg_sel_hh */
#define BL702_GLB_DEBUG_OFFSET              0x0000e0  /* debug */
#define BL702_GPIO_CFGCTL0_OFFSET           0x000100  /* gpio_cfgctl0 */
#define BL702_GPIO_CFGCTL1_OFFSET           0x000104  /* gpio_cfgctl1 */
#define BL702_GPIO_CFGCTL2_OFFSET           0x000108  /* gpio_cfgctl2 */
#define BL702_GPIO_CFGCTL3_OFFSET           0x00010c  /* gpio_cfgctl3 */
#define BL702_GPIO_CFGCTL4_OFFSET           0x000110  /* gpio_cfgctl4 */
#define BL702_GPIO_CFGCTL5_OFFSET           0x000114  /* gpio_cfgctl5 */
#define BL702_GPIO_CFGCTL6_OFFSET           0x000118  /* gpio_cfgctl6 */
#define BL702_GPIO_CFGCTL7_OFFSET           0x00011c  /* gpio_cfgctl7 */
#define BL702_GPIO_CFGCTL8_OFFSET           0x000120  /* gpio_cfgctl8 */
#define BL702_GPIO_CFGCTL9_OFFSET           0x000124  /* gpio_cfgctl9 */
#define BL702_GPIO_CFGCTL10_OFFSET          0x000128  /* gpio_cfgctl10 */
#define BL702_GPIO_CFGCTL11_OFFSET          0x00012c  /* gpio_cfgctl11 */
#define BL702_GPIO_CFGCTL12_OFFSET          0x000130  /* gpio_cfgctl12 */
#define BL702_GPIO_CFGCTL13_OFFSET          0x000134  /* gpio_cfgctl13 */
#define BL702_GPIO_CFGCTL14_OFFSET          0x000138  /* gpio_cfgctl14 */
#define BL702_GPIO_CFGCTL30_OFFSET          0x000180  /* gpio_cfgctl30 */
#define BL702_GPIO_CFGCTL31_OFFSET          0x000184  /* gpio_cfgctl31 */
#define BL702_GPIO_CFGCTL32_OFFSET          0x000188  /* gpio_cfgctl32 */
#define BL702_GPIO_CFGCTL33_OFFSET          0x00018c  /* gpio_cfgctl33 */
#define BL702_GPIO_CFGCTL34_OFFSET          0x000190  /* gpio_cfgctl34 */
#define BL702_GPIO_CFGCTL35_OFFSET          0x000194  /* gpio_cfgctl35 */
#define BL702_GPIO_INT_MASK1_OFFSET         0x0001a0  /* gpio_int_mask1 */
#define BL702_GPIO_INT_STAT1_OFFSET         0x0001a8  /* gpio_int_stat1 */
#define BL702_GPIO_INT_CLR1_OFFSET          0x0001b0  /* gpio_int_clr1 */
#define BL702_GPIO_INT_MODE_SET1_OFFSET     0x0001c0  /* gpio_int_mode_set1 */
#define BL702_GPIO_INT_MODE_SET2_OFFSET     0x0001c4  /* gpio_int_mode_set2 */
#define BL702_GPIO_INT_MODE_SET3_OFFSET     0x0001c8  /* gpio_int_mode_set3 */
#define BL702_LED_DRIVER_OFFSET             0x000224  /* led_driver */
#define BL702_GPDAC_CTRL_OFFSET             0x000308  /* gpdac_ctrl */
#define BL702_GPDAC_ACTRL_OFFSET            0x00030c  /* gpdac_actrl */
#define BL702_GPDAC_BCTRL_OFFSET            0x000310  /* gpdac_bctrl */
#define BL702_GPDAC_DATA_OFFSET             0x000314  /* gpdac_data */
#define BL702_TZC_GLB_CTRL_0_OFFSET         0x000f00  /* tzc_glb_ctrl_0 */
#define BL702_TZC_GLB_CTRL_1_OFFSET         0x000f04  /* tzc_glb_ctrl_1 */
#define BL702_TZC_GLB_CTRL_2_OFFSET         0x000f08  /* tzc_glb_ctrl_2 */
#define BL702_TZC_GLB_CTRL_3_OFFSET         0x000f0c  /* tzc_glb_ctrl_3 */

/* Register definitions *****************************************************/

#define BL702_CLK_CFG0            (BL702_GLB_BASE + BL702_CLK_CFG0_OFFSET)
#define BL702_CLK_CFG1            (BL702_GLB_BASE + BL702_CLK_CFG1_OFFSET)
#define BL702_CLK_CFG2            (BL702_GLB_BASE + BL702_CLK_CFG2_OFFSET)
#define BL702_CLK_CFG3            (BL702_GLB_BASE + BL702_CLK_CFG3_OFFSET)
#define BL702_SWRST_CFG0          (BL702_GLB_BASE + BL702_SWRST_CFG0_OFFSET)
#define BL702_SWRST_CFG1          (BL702_GLB_BASE + BL702_SWRST_CFG1_OFFSET)
#define BL702_SWRST_CFG2          (BL702_GLB_BASE + BL702_SWRST_CFG2_OFFSET)
#define BL702_SWRST_CFG3          (BL702_GLB_BASE + BL702_SWRST_CFG3_OFFSET)
#define BL702_CGEN_CFG0           (BL702_GLB_BASE + BL702_CGEN_CFG0_OFFSET)
#define BL702_CGEN_CFG1           (BL702_GLB_BASE + BL702_CGEN_CFG1_OFFSET)
#define BL702_CGEN_CFG2           (BL702_GLB_BASE + BL702_CGEN_CFG2_OFFSET)
#define BL702_CGEN_CFG3           (BL702_GLB_BASE + BL702_CGEN_CFG3_OFFSET)
#define BL702_MBIST_CTL           (BL702_GLB_BASE + BL702_MBIST_CTL_OFFSET)
#define BL702_MBIST_STAT          (BL702_GLB_BASE + BL702_MBIST_STAT_OFFSET)
#define BL702_BMX_CFG1            (BL702_GLB_BASE + BL702_BMX_CFG1_OFFSET)
#define BL702_BMX_CFG2            (BL702_GLB_BASE + BL702_BMX_CFG2_OFFSET)
#define BL702_BMX_ERR_ADDR        (BL702_GLB_BASE + BL702_BMX_ERR_ADDR_OFFSET)
#define BL702_BMX_DBG_OUT         (BL702_GLB_BASE + BL702_BMX_DBG_OUT_OFFSET)
#define BL702_GLB_RSV0            (BL702_GLB_BASE + BL702_GLB_RSV0_OFFSET)
#define BL702_GLB_RSV1            (BL702_GLB_BASE + BL702_GLB_RSV1_OFFSET)
#define BL702_GLB_RSV2            (BL702_GLB_BASE + BL702_GLB_RSV2_OFFSET)
#define BL702_GLB_RSV3            (BL702_GLB_BASE + BL702_GLB_RSV3_OFFSET)
#define BL702_SRAM_RET            (BL702_GLB_BASE + BL702_SRAM_RET_OFFSET)
#define BL702_SRAM_SLP            (BL702_GLB_BASE + BL702_SRAM_SLP_OFFSET)
#define BL702_SRAM_PARM           (BL702_GLB_BASE + BL702_SRAM_PARM_OFFSET)
#define BL702_SEAM_MISC           (BL702_GLB_BASE + BL702_SEAM_MISC_OFFSET)
#define BL702_GLB_GLB_PARM        (BL702_GLB_BASE + BL702_GLB_PARM_OFFSET)
#define BL702_CPU_CLK_CFG         (BL702_GLB_BASE + BL702_CPU_CLK_CFG_OFFSET)
#define BL702_GPADC_32M_SRC_CTRL  (BL702_GLB_BASE + BL702_GPADC_32M_SRC_CTRL_OFFSET)
#define BL702_DIG32K_WAKEUP_CTRL  (BL702_GLB_BASE + BL702_DIG32K_WAKEUP_CTRL_OFFSET)
#define BL702_WIFI_BT_COEX_CTRL   (BL702_GLB_BASE + BL702_WIFI_BT_COEX_CTRL_OFFSET)
#define BL702_UART_SIG_SEL_0      (BL702_GLB_BASE + BL702_UART_SIG_SEL_0_OFFSET)
#define BL702_GLB_DBG_SEL_LL      (BL702_GLB_BASE + BL702_GLB_DBG_SEL_LL_OFFSET)
#define BL702_GLB_DBG_SEL_LH      (BL702_GLB_BASE + BL702_GLB_DBG_SEL_LH_OFFSET)
#define BL702_GLB_DBG_SEL_HL      (BL702_GLB_BASE + BL702_GLB_DBG_SEL_HL_OFFSET)
#define BL702_GLB_DBG_SEL_HH      (BL702_GLB_BASE + BL702_GLB_DBG_SEL_HH_OFFSET)
#define BL702_GLB_DEBUG           (BL702_GLB_BASE + BL702_GLB_DEBUG_OFFSET)
#define BL702_GPIO_CFGCTL0        (BL702_GLB_BASE + BL702_GPIO_CFGCTL0_OFFSET)
#define BL702_GPIO_CFGCTL1        (BL702_GLB_BASE + BL702_GPIO_CFGCTL1_OFFSET)
#define BL702_GPIO_CFGCTL2        (BL702_GLB_BASE + BL702_GPIO_CFGCTL2_OFFSET)
#define BL702_GPIO_CFGCTL3        (BL702_GLB_BASE + BL702_GPIO_CFGCTL3_OFFSET)
#define BL702_GPIO_CFGCTL4        (BL702_GLB_BASE + BL702_GPIO_CFGCTL4_OFFSET)
#define BL702_GPIO_CFGCTL5        (BL702_GLB_BASE + BL702_GPIO_CFGCTL5_OFFSET)
#define BL702_GPIO_CFGCTL6        (BL702_GLB_BASE + BL702_GPIO_CFGCTL6_OFFSET)
#define BL702_GPIO_CFGCTL7        (BL702_GLB_BASE + BL702_GPIO_CFGCTL7_OFFSET)
#define BL702_GPIO_CFGCTL8        (BL702_GLB_BASE + BL702_GPIO_CFGCTL8_OFFSET)
#define BL702_GPIO_CFGCTL9        (BL702_GLB_BASE + BL702_GPIO_CFGCTL9_OFFSET)
#define BL702_GPIO_CFGCTL10       (BL702_GLB_BASE + BL702_GPIO_CFGCTL10_OFFSET)
#define BL702_GPIO_CFGCTL11       (BL702_GLB_BASE + BL702_GPIO_CFGCTL11_OFFSET)
#define BL702_GPIO_CFGCTL12       (BL702_GLB_BASE + BL702_GPIO_CFGCTL12_OFFSET)
#define BL702_GPIO_CFGCTL13       (BL702_GLB_BASE + BL702_GPIO_CFGCTL13_OFFSET)
#define BL702_GPIO_CFGCTL14       (BL702_GLB_BASE + BL702_GPIO_CFGCTL14_OFFSET)
#define BL702_GPIO_CFGCTL30       (BL702_GLB_BASE + BL702_GPIO_CFGCTL30_OFFSET)
#define BL702_GPIO_CFGCTL31       (BL702_GLB_BASE + BL702_GPIO_CFGCTL31_OFFSET)
#define BL702_GPIO_CFGCTL32       (BL702_GLB_BASE + BL702_GPIO_CFGCTL32_OFFSET)
#define BL702_GPIO_CFGCTL33       (BL702_GLB_BASE + BL702_GPIO_CFGCTL33_OFFSET)
#define BL702_GPIO_CFGCTL34       (BL702_GLB_BASE + BL702_GPIO_CFGCTL34_OFFSET)
#define BL702_GPIO_CFGCTL35       (BL702_GLB_BASE + BL702_GPIO_CFGCTL35_OFFSET)
#define BL702_GPIO_INT_MASK1      (BL702_GLB_BASE + BL702_GPIO_INT_MASK1_OFFSET)
#define BL702_GPIO_INT_STAT1      (BL702_GLB_BASE + BL702_GPIO_INT_STAT1_OFFSET)
#define BL702_GPIO_INT_CLR1       (BL702_GLB_BASE + BL702_GPIO_INT_CLR1_OFFSET)
#define BL702_GPIO_INT_MODE_SET1  (BL702_GLB_BASE + BL702_GPIO_INT_MODE_SET1_OFFSET)
#define BL702_GPIO_INT_MODE_SET2  (BL702_GLB_BASE + BL702_GPIO_INT_MODE_SET2_OFFSET)
#define BL702_GPIO_INT_MODE_SET3  (BL702_GLB_BASE + BL702_GPIO_INT_MODE_SET3_OFFSET)
#define BL702_LED_DRIVER          (BL702_GLB_BASE + BL702_LED_DRIVER_OFFSET)
#define BL702_GPDAC_CTRL          (BL702_GLB_BASE + BL702_GPDAC_CTRL_OFFSET)
#define BL702_GPDAC_ACTRL         (BL702_GLB_BASE + BL702_GPDAC_ACTRL_OFFSET)
#define BL702_GPDAC_BCTRL         (BL702_GLB_BASE + BL702_GPDAC_BCTRL_OFFSET)
#define BL702_GPDAC_DATA          (BL702_GLB_BASE + BL702_GPDAC_DATA_OFFSET)
#define BL702_TZC_GLB_CTRL_0      (BL702_GLB_BASE + BL702_TZC_GLB_CTRL_0_OFFSET)
#define BL702_TZC_GLB_CTRL_1      (BL702_GLB_BASE + BL702_TZC_GLB_CTRL_1_OFFSET)
#define BL702_TZC_GLB_CTRL_2      (BL702_GLB_BASE + BL702_TZC_GLB_CTRL_2_OFFSET)
#define BL702_TZC_GLB_CTRL_3      (BL702_GLB_BASE + BL702_TZC_GLB_CTRL_3_OFFSET)
