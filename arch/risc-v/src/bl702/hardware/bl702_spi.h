/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_spi.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_SPI_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_SPI_H
...
#define BL702_SPI_CFG_OFFSET            0x000000  /* spi_config */
#define BL702_SPI_INT_STS_OFFSET        0x000004  /* spi_int_sts */
#define BL702_SPI_BUS_BUSY_OFFSET       0x000008  /* spi_bus_busy */
#define BL702_SPI_PRD_0_OFFSET          0x000010  /* spi_prd_0 */
#define BL702_SPI_PRD_1_OFFSET          0x000014  /* spi_prd_1 */
#define BL702_SPI_RXD_IGNR_OFFSET       0x000018  /* spi_rxd_ignr */
#define BL702_SPI_STO_VALUE_OFFSET      0x00001c  /* spi_sto_value */
#define BL702_SPI_FIFO_CFG_0_OFFSET     0x000080  /* spi_fifo_config_0 */
#define BL702_SPI_FIFO_CFG_1_OFFSET     0x000084  /* spi_fifo_config_1 */
#define BL702_SPI_FIFO_WDATA_OFFSET     0x000088  /* spi_fifo_wdata */
#define BL702_SPI_FIFO_RDATA_OFFSET     0x00008c  /* spi_fifo_rdata */

/* Register definitions *****************************************************/

#define BL702_SPI_CFG            (BL702_SPI_BASE + BL702_SPI_CFG_OFFSET)
#define BL702_SPI_INT_STS        (BL702_SPI_BASE + BL702_SPI_INT_STS_OFFSET)
#define BL702_SPI_BUS_BUSY       (BL702_SPI_BASE + BL702_SPI_BUS_BUSY_OFFSET)
#define BL702_SPI_PRD_0          (BL702_SPI_BASE + BL702_SPI_PRD_0_OFFSET)
#define BL702_SPI_PRD_1          (BL702_SPI_BASE + BL702_SPI_PRD_1_OFFSET)
#define BL702_SPI_RXD_IGNR       (BL702_SPI_BASE + BL702_SPI_RXD_IGNR_OFFSET)
#define BL702_SPI_STO_VALUE      (BL702_SPI_BASE + BL702_SPI_STO_VALUE_OFFSET)
#define BL702_SPI_FIFO_CFG_0     (BL702_SPI_BASE + BL702_SPI_FIFO_CFG_0_OFFSET)
#define BL702_SPI_FIFO_CFG_1     (BL702_SPI_BASE + BL702_SPI_FIFO_CFG_1_OFFSET)
#define BL702_SPI_FIFO_WDATA     (BL702_SPI_BASE + BL702_SPI_FIFO_WDATA_OFFSET)
#define BL702_SPI_FIFO_RDATA     (BL702_SPI_BASE + BL702_SPI_FIFO_RDATA_OFFSET)
...
#endif /* __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_SPI_H */
