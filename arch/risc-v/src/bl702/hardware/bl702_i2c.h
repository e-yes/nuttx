/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_i2c.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_I2C_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_I2C_H
...
#define BL702_I2C_CONFIG_OFFSET         0x000000  /* i2c_config */
#define BL702_I2C_INT_STS_OFFSET        0x000004  /* i2c_int_sts */
#define BL702_I2C_SUB_ADDR_OFFSET       0x000008  /* i2c_sub_addr */
#define BL702_I2C_BUS_BUSY_OFFSET       0x00000c  /* i2c_bus_busy */
#define BL702_I2C_PRD_START_OFFSET      0x000010  /* i2c_prd_start */
#define BL702_I2C_PRD_STOP_OFFSET       0x000014  /* i2c_prd_stop */
#define BL702_I2C_PRD_DATA_OFFSET       0x000018  /* i2c_prd_data */
#define BL702_I2C_FIFO_CONFIG_0_OFFSET  0x000080  /* i2c_fifo_config_0 */
#define BL702_I2C_FIFO_CONFIG_1_OFFSET  0x000084  /* i2c_fifo_config_1 */
#define BL702_I2C_FIFO_WDATA_OFFSET     0x000088  /* i2c_fifo_wdata */
#define BL702_I2C_FIFO_RDATA_OFFSET     0x00008c  /* i2c_fifo_rdata */

/* Register definitions *****************************************************/

#define BL702_I2C_CONFIG     (BL702_I2C_BASE + BL702_I2C_CONFIG_OFFSET)
#define BL702_I2C_INT_STS    (BL702_I2C_BASE + BL702_I2C_INT_STS_OFFSET)
#define BL702_I2C_SUB_ADDR   (BL702_I2C_BASE + BL702_I2C_SUB_ADDR_OFFSET)
#define BL702_I2C_BUS_BUSY   (BL702_I2C_BASE + BL702_I2C_BUS_BUSY_OFFSET)
#define BL702_I2C_PRD_START  (BL702_I2C_BASE + BL702_I2C_PRD_START_OFFSET)
#define BL702_I2C_PRD_STOP   (BL702_I2C_BASE + BL702_I2C_PRD_STOP_OFFSET)
#define BL702_I2C_PRD_DATA   (BL702_I2C_BASE + BL702_I2C_PRD_DATA_OFFSET)
#define BL702_I2C_FIFO_CONFIG_0  \
          (BL702_I2C_BASE + BL702_I2C_FIFO_CONFIG_0_OFFSET)
#define BL702_I2C_FIFO_CONFIG_1  \
          (BL702_I2C_BASE + BL702_I2C_FIFO_CONFIG_1_OFFSET)
#define BL702_I2C_FIFO_WDATA     \
          (BL702_I2C_BASE + BL702_I2C_FIFO_WDATA_OFFSET)
#define BL702_I2C_FIFO_RDATA     \
          (BL702_I2C_BASE + BL702_I2C_FIFO_RDATA_OFFSET)
...
#endif /* __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_I2C_H */
