/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_gpip.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_GPIP_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_GPIP_H
...
#define BL702_GPADC_CONFIG_OFFSET          0x000000  /* gpadc_config */
#define BL702_GPADC_DMA_RDATA_OFFSET       0x000004  /* gpadc_dma_rdata */
#define BL702_GPDAC_CONFIG_OFFSET          0x000040  /* gpdac_config */
#define BL702_GPDAC_DMA_CONFIG_OFFSET      0x000044  /* gpdac_dma_config */
#define BL702_GPDAC_DMA_WDATA_OFFSET       0x000048  /* gpdac_dma_wdata */
#define BL702_GPDAC_TX_FIFO_STATUS_OFFSET  0x00004c  /* gpdac_tx_fifo_status */

/* Register definitions *****************************************************/

#define BL702_GPADC_CONFIG          (BL702_GPIP_BASE + BL702_GPADC_CONFIG_OFFSET)
#define BL702_GPADC_DMA_RDATA       (BL702_GPIP_BASE + BL702_GPADC_DMA_RDATA_OFFSET)
#define BL702_GPDAC_CONFIG          (BL702_GPIP_BASE + BL702_GPDAC_CONFIG_OFFSET)
#define BL702_GPDAC_DMA_CONFIG      (BL702_GPIP_BASE + BL702_GPDAC_DMA_CONFIG_OFFSET)
#define BL702_GPDAC_DMA_WDATA       (BL702_GPIP_BASE + BL702_GPDAC_DMA_WDATA_OFFSET)
#define BL702_GPDAC_TX_FIFO_STATUS  (BL702_GPIP_BASE + BL702_GPDAC_TX_FIFO_STATUS_OFFSET)
...
#endif /* __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_GPIP_H */
