/****************************************************************************
 * arch/risc-v/src/bl702/hardware/bl702_dma.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_DMA_H
#define __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_DMA_H
...
#define BL702_DMA_INTSTATUS_OFFSET          0x000000  /* IntStatus */
#define BL702_DMA_INTTCSTATUS_OFFSET        0x000004  /* IntTCStatus */
#define BL702_DMA_INTTCCLEAR_OFFSET         0x000008  /* IntTCClear */
#define BL702_DMA_INTERRORSTATUS_OFFSET     0x00000c  /* IntErrorStatus */
#define BL702_DMA_INTERRCLR_OFFSET          0x000010  /* IntErrClr */
#define BL702_DMA_RAWINTTCSTATUS_OFFSET     0x000014  /* RawIntTCStatus */
#define BL702_DMA_RAWINTERRORSTATUS_OFFSET  0x000018  /* RawIntErrorStatus */
#define BL702_DMA_ENBLDCHNS_OFFSET          0x00001c  /* EnbldChns */
#define BL702_DMA_SOFTBREQ_OFFSET           0x000020  /* SoftBReq */
#define BL702_DMA_SOFTSREQ_OFFSET           0x000024  /* SoftSReq */
#define BL702_DMA_SOFTLBREQ_OFFSET          0x000028  /* SoftLBReq */
#define BL702_DMA_SOFTLSREQ_OFFSET          0x00002c  /* SoftLSReq */
#define BL702_DMA_TOP_CONFIG_OFFSET         0x000030  /* Top_Config */
#define BL702_DMA_SYNC_OFFSET               0x000034  /* Sync */
#define BL702_DMA_C0SRCADDR_OFFSET          0x000100  /* C0SrcAddr */
#define BL702_DMA_C0DSTADDR_OFFSET          0x000104  /* C0DstAddr */
#define BL702_DMA_C0LLI_OFFSET              0x000108  /* C0LLI */
#define BL702_DMA_C0CONTROL_OFFSET          0x00010c  /* C0Control */
#define BL702_DMA_C0CONFIG_OFFSET           0x000110  /* C0Config */
#define BL702_DMA_C1SRCADDR_OFFSET          0x000200  /* C1SrcAddr */
#define BL702_DMA_C1DSTADDR_OFFSET          0x000204  /* C1DstAddr */
#define BL702_DMA_C1LLI_OFFSET              0x000208  /* C1LLI */
#define BL702_DMA_C1CONTROL_OFFSET          0x00020c  /* C1Control */
#define BL702_DMA_C1CONFIG_OFFSET           0x000210  /* C1Config */
#define BL702_DMA_C2SRCADDR_OFFSET          0x000300  /* C2SrcAddr */
#define BL702_DMA_C2DSTADDR_OFFSET          0x000304  /* C2DstAddr */
#define BL702_DMA_C2LLI_OFFSET              0x000308  /* C2LLI */
#define BL702_DMA_C2CONTROL_OFFSET          0x00030c  /* C2Control */
#define BL702_DMA_C2CONFIG_OFFSET           0x000310  /* C2Config */
#define BL702_DMA_C3SRCADDR_OFFSET          0x000400  /* C3SrcAddr */
#define BL702_DMA_C3DSTADDR_OFFSET          0x000404  /* C3DstAddr */
#define BL702_DMA_C3LLI_OFFSET              0x000408  /* C3LLI */
#define BL702_DMA_C3CONTROL_OFFSET          0x00040c  /* C3Control */
#define BL702_DMA_C3CONFIG_OFFSET           0x000410  /* C3Config */

/* Register definitions *****************************************************/

#define BL702_DMA_INTSTATUS          (BL702_DMA_BASE + BL702_DMA_INTSTATUS_OFFSET)
#define BL702_DMA_INTTCSTATUS        (BL702_DMA_BASE + BL702_DMA_INTTCSTATUS_OFFSET)
#define BL702_DMA_INTTCCLEAR         (BL702_DMA_BASE + BL702_DMA_INTTCCLEAR_OFFSET)
#define BL702_DMA_INTERRORSTATUS     (BL702_DMA_BASE + BL702_DMA_INTERRORSTATUS_OFFSET)
#define BL702_DMA_INTERRCLR          (BL702_DMA_BASE + BL702_DMA_INTERRCLR_OFFSET)
#define BL702_DMA_RAWINTTCSTATUS     (BL702_DMA_BASE + BL702_DMA_RAWINTTCSTATUS_OFFSET)
#define BL702_DMA_RAWINTERRORSTATUS  (BL702_DMA_BASE + BL702_DMA_RAWINTERRORSTATUS_OFFSET)
#define BL702_DMA_ENBLDCHNS          (BL702_DMA_BASE + BL702_DMA_ENBLDCHNS_OFFSET)
#define BL702_DMA_SOFTBREQ           (BL702_DMA_BASE + BL702_DMA_SOFTBREQ_OFFSET)
#define BL702_DMA_SOFTSREQ           (BL702_DMA_BASE + BL702_DMA_SOFTSREQ_OFFSET)
#define BL702_DMA_SOFTLBREQ          (BL702_DMA_BASE + BL702_DMA_SOFTLBREQ_OFFSET)
#define BL702_DMA_SOFTLSREQ          (BL702_DMA_BASE + BL702_DMA_SOFTLSREQ_OFFSET)
#define BL702_DMA_TOP_CONFIG         (BL702_DMA_BASE + BL702_DMA_TOP_CONFIG_OFFSET)
#define BL702_DMA_SYNC               (BL702_DMA_BASE + BL702_DMA_SYNC_OFFSET)
#define BL702_DMA_C0SRCADDR          (BL702_DMA_BASE + BL702_DMA_C0SRCADDR_OFFSET)
#define BL702_DMA_C0DSTADDR          (BL702_DMA_BASE + BL702_DMA_C0DSTADDR_OFFSET)
#define BL702_DMA_C0LLI              (BL702_DMA_BASE + BL702_DMA_C0LLI_OFFSET)
#define BL702_DMA_C0CONTROL          (BL702_DMA_BASE + BL702_DMA_C0CONTROL_OFFSET)
#define BL702_DMA_C0CONFIG           (BL702_DMA_BASE + BL702_DMA_C0CONFIG_OFFSET)
#define BL702_DMA_C1SRCADDR          (BL702_DMA_BASE + BL702_DMA_C1SRCADDR_OFFSET)
#define BL702_DMA_C1DSTADDR          (BL702_DMA_BASE + BL702_DMA_C1DSTADDR_OFFSET)
#define BL702_DMA_C1LLI              (BL702_DMA_BASE + BL702_DMA_C1LLI_OFFSET)
#define BL702_DMA_C1CONTROL          (BL702_DMA_BASE + BL702_DMA_C1CONTROL_OFFSET)
#define BL702_DMA_C1CONFIG           (BL702_DMA_BASE + BL702_DMA_C1CONFIG_OFFSET)
#define BL702_DMA_C2SRCADDR          (BL702_DMA_BASE + BL702_DMA_C2SRCADDR_OFFSET)
#define BL702_DMA_C2DSTADDR          (BL702_DMA_BASE + BL702_DMA_C2DSTADDR_OFFSET)
#define BL702_DMA_C2LLI              (BL702_DMA_BASE + BL702_DMA_C2LLI_OFFSET)
#define BL702_DMA_C2CONTROL          (BL702_DMA_BASE + BL702_DMA_C2CONTROL_OFFSET)
#define BL702_DMA_C2CONFIG           (BL702_DMA_BASE + BL702_DMA_C2CONFIG_OFFSET)
#define BL702_DMA_C3SRCADDR          (BL702_DMA_BASE + BL702_DMA_C3SRCADDR_OFFSET)
#define BL702_DMA_C3DSTADDR          (BL702_DMA_BASE + BL702_DMA_C3DSTADDR_OFFSET)
#define BL702_DMA_C3LLI              (BL702_DMA_BASE + BL702_DMA_C3LLI_OFFSET)
#define BL702_DMA_C3CONTROL          (BL702_DMA_BASE + BL702_DMA_C3CONTROL_OFFSET)
#define BL702_DMA_C3CONFIG           (BL702_DMA_BASE + BL702_DMA_C3CONFIG_OFFSET)
...
#endif /* __ARCH_RISCV_SRC_BL702_HARDWARE_BL702_DMA_H */
