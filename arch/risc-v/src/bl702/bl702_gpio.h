/****************************************************************************
 * arch/risc-v/src/bl702/bl702_gpio.h
 *
...
#ifndef __ARCH_RISCV_SRC_BL702_BL702_GPIO_H
#define __ARCH_RISCV_SRC_BL702_BL702_GPIO_H
...
/* Bit-encoded input to bl702_configgpio() */
...
int bl702_configgpio(gpio_pinset_t cfgset);

/****************************************************************************
 * Name: bl702_gpio_deinit
 *
 * Description:
...
int bl702_gpio_deinit(uint8_t pin);

/****************************************************************************
 * Name: bl702_config_uart_sel
 *
 * Description:
...
int bl702_config_uart_sel(gpio_pinset_t cfgset, uint8_t sig_sel);

/****************************************************************************
 * Name: bl702_gpiowrite
 *
 * Description:
...
void bl702_gpiowrite(gpio_pinset_t pinset, bool value);
...
bool bl702_gpioread(gpio_pinset_t pinset);

/****************************************************************************
 * Name: bl702_gpiosetevent
 *
 * Description:
...
int bl702_gpiosetevent(gpio_pinset_t pinset,
                       bool          risingedge,
                       bool          fallingedge,
                       bool          event,
                       xcpt_t        func,
...
int bl702_dumpgpio(gpio_pinset_t pinset, const char *msg);
#else
#define bl702_dumpgpio(p, m)
#endif
...
#endif /* __ASSEMBLY__ */
#endif /* __ARCH_RISCV_SRC_BL702_BL702_GPIO_H */
