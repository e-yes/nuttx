/****************************************************************************
 * boards/risc-v/bl702/bl702iot/include/board.h
 *
...
#ifndef __BOARDS_RISCV_BL702_BL702IOT_INCLUDE_BOARD_H
#define __BOARDS_RISCV_BL702_BL702IOT_INCLUDE_BOARD_H
...
/* Do not include BL702 header files here. */
...
#define BOARD_UART_0_RX_PIN (GPIO_INPUT | GPIO_PULLUP | \
                              GPIO_FUNC_UART | GPIO_PIN15)
#define BOARD_UART_0_TX_PIN (GPIO_INPUT | GPIO_PULLUP | \
                              GPIO_FUNC_UART | GPIO_PIN14)
...
/****************************************************************************
 * Name: bl702_boardinitialize
 ****************************************************************************/

void bl702_boardinitialize(void);
...
#endif
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_RISC_V_BL702_BL702IOT_INCLUDE_BOARD_H */
